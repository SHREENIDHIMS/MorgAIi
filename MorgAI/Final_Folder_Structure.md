...
│   ├── app/
│   │   ├── main.py
│   │   ├── config.py                       # ranking weights / thresholds, DB-driven
│   │   ├── dependencies.py
│   │   │
│   │   ├── api/
│   │   │   ├── v1/
...
│   ├── systemd/
│   │   ├── mortgage-backend.socket           # on-demand activation
│   │   ├── mortgage-backend.service
│   │   ├── mortgage-backend-idle.timer       # checks every 5 min
│   │   └── mortgage-backend-idle.service
│   ├── scripts/
...
# │   ├── postgresql.conf
# │   └── init/
# │       ├── 01_mortgage_assistant.sql
# │       └── 02_<other-project>.sql
# └── nginx/
#     └── conf.d/
#         ├── mortgage-assistant.conf
#         └── <other-project>.conf
```
